...
def get_activities(
    ...
    - difficulty_level: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'All' for activities without difficulty)
    """
    ...
    if difficulty_level:
        if difficulty_level == "All":
            # "All" means activities without any difficulty level specified
